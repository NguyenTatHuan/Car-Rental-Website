...
import com.springproject.service.elasticsearch.userInformation.UserInformationSearchService;
...
public class AdminUserInformationController {
    ...
    private final UserInformationSearchService userInformationSearchService;
    ...
    @GetMapping("/search")
    public ResponseEntity<List<UserInformationDocument>> searchUserInformation(@RequestParam("keyword") String keyword) {
        return ResponseEntity.ok(userInformationSearchService.searchByKeyword(keyword.trim()));
    }
